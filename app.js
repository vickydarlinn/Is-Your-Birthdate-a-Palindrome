...
function birthDateCombination(dob) {
  ...
  const yyddmm =
    originalDateStr[0].substring(2) + originalDateStr[2] + originalDateStr[1];

  //dd-mm-yy
  const ddmmyy =
    splittedString[0] + splittedString[1] + splittedString[2].substring(2);
  ...
  // m-dd-yyyy
  const mddyyyy =
    splittedString[0].substring(1) + splittedString[1] + splittedString[2];

  if (
    checkBirthDatePalindrome(dob) ||
    checkBirthDatePalindrome(ddmmyyyy) ||
    checkBirthDatePalindrome(mmddyy) ||
    checkBirthDatePalindrome(mddyyyy) ||
    checkBirthDatePalindrome(ddmmyy) ||
    checkBirthDatePalindrome(mmddyyyy) ||
    checkBirthDatePalindrome(yyddmm)
  ) {
